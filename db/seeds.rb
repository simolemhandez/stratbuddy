...
<br><br>When thinking about annual giving, I would want to think about number of donors (directly correlated with number of customers), amount contributed per donor (change the mix of donors or convince existing donors to give more).
<br><br>When thinking about endowment levers, I would want to think about the size of the endowment base (donations to increase endowment base, returns from invested funds) and the annual endowment draw percentage.',
...
Question.create(
  ...
  timing: 3,
  correction: '- Increase ticket price. MSO could be under-pricing or not taking advantage of price discrimination opportunities<br><br>
- Increase number of performances. There may be room to expand the symphony season, play in other locales, and/or have more performances of each program.<br><br>
...
<br>Improve promotion. There may be a need to change core messages, media choices, or frequency of promotion
<br>Improve sales strategy. Alternatives include adjusting sales channel mix (e.g., telemarketing, internet, direct mail); sales force composition, incentives, and/or the structure of the marketing organization
...
',
  timing: 3,
  correction: 'Overall observations:<br>
- Overall earned income is down because of a decline in subscription sales, with full-season subscription sales being particularly hard hit<br><br>
- Total subscription revenues are down, but not because subscriber renewal rates are falling- Individual ticket sales are up, which partially—but not fully— offsets the decline in subscription revenues<br><br>
Possible explanations for the results (Remember that pricing and marketing strategy have not changed during the past 3 years):<br>
...
<br><br>A very good answer might also include:
...
o New subscribers tend to have lower renewal rates than long-time subscribers, so fewer new subscribers may explain why the MSO’s overall renewal rates have not suffered<br>
- The above hypotheses could be due to one or more underlying causes<br>
o Weak local economy and less disposable income<br>
o General shift in customer preferences away from full-season subscriptions
and towards shorter-term subscriptions and single tickets<br>
o Decrease in size of MSO’s historic key target customer segments (e.g.,
older, high-income individuals)<br>
o MSO product offering has become weaker relative to other performing arts
or entertainment options.<br>
  5',
  skills: 'Logic and rigorous thinking',
  keywords: ['increase price', 'offering', 'promotion', 'mix', 'customer segment'],
  case_id: c.id,
...
o Level of donations per capita within the metro area<br>
...
o MSO donations as  percentage of estimated total giving potential (from both local and national sources) by donor type<br>
o percentage of wealthiest 50/100/500 local corporations/ foundations / people currently not giving to MSO<br>
o Inventory of local, state, and/or national government funding sources not being utilized by MSO.<br><br>
A very good answer might include the following:<br>
Historical trend analyses<br>
...
Question.create(
  ...
  timing: 3,
  correction: 'Potential recommendations:<br>
...
perhaps younger—market segments is a bold but potentially winning strategy. However, new customers carry high acquisition costs, so this might be a second- priority initiative (e.g., one that is pursued after renewal rates improve).<br>
<br><br>Challenges:
<br>Cannibalization
...
<br><br>A very good answer might include the following:
<br>Potential Recommendations:
...
<br>Challenges:
<br>MSO’s lack of sales and marketing acumen, skills
   10
...
Question.create(
  ...
  all stores. They do not believe targeting and closing underperforming stores is an appropriate solution.<br><br>
...
<br>• All non-operating expenses/costs are appropriately benchmarked to the industry.
<br>• Private label brands are commonly referred to as store brands like 365 at Whole Foods or Kirkland’s at Costco. Hard discounters such as Trader Joe’s rely heavily on private label brands. National brands come from CPG firms such as General Mills or Kraft. CPG firms require a margin on their products that’s not applicable to private label brands.
<br>• DJ’s had 2016 revenue of $60 billion with 30 percent gross margin and 3 percent profit margin.
<br>• Management wants to increase the profits by 10% within the next year',
  skills: 'Logic and rigorous thinking',
